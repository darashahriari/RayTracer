 ...
 * specify how to perform anti-aliasing, the maximum depth for reflection and
...
public class Render extends WindowAdapter {
	 ...
	 * Also, this method creates and displays a render window. Closing this window
	 * will cancel rendering.
	 * 
	 * @param width
	 * @param height
	 */
